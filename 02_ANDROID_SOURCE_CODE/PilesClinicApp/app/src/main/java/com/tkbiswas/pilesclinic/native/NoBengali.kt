...
object NoBengali {
    ...
    /* 🟢🔒 V591 (২৩.০৮.২০২৬) — **সংখ্যা বসা ঘর**। `"ফোলা $piles টা"` ·
       ...
       যায় না — আর তালিকায় না থাকায় শেষ-জাল "টা"-টুকু **মুছে** দিত।
         · "3 টা" → "3 नग"   (কয়টা — গোনা)
         · "3টা"  → "3 बजे"  (ঘড়ির কাঁটা)
    ...
    fun fix(text: CharSequence?): CharSequence? {
        ...
        if (s.contains("টা")) {
            s = NUM_COUNT.replace(s) { m -> m.groupValues[1] + " नग" }
            s = NUM_OCLOCK.replace(s) { m -> m.groupValues[1] + " बजे" }
        }
        if (hasBengali(s)) {
    ...
    private val HINDI: Map<String, String> = mapOf(
        /* 🔤🔒 V728 (২৭.০৮.২০২৬, TK-নির্দেশে পপ-আপ ইংরেজি করার সময়) —
           নিচের চারটে লেখা আগে বাংলায় ছিল, তাই হিন্দির চাবিও বাংলা ছিল।
           এখন কোডে লেখাগুলো **ইংরেজি**, তাই বাংলা চাবি আর মেলে না ⇒ কিষানগঞ্জের
           স্টাফ (KNE-KISHAN5) হিন্দি হারাতেন। সেই জন্য **ইংরেজি→হিন্দি** জোড়া
           এখানে যোগ করা হলো — হিন্দি হুবহু আগেরটাই।
           ⛔ প্রতিটা ইংরেজি চাবি **যাচাই করে** নেওয়া হয়েছে: গোটা প্রজেক্টের আর
              কোনো লেখায় এগুলো নেই (সংঘর্ষ ০) — তাই অন্য কোনো পর্দার লেখা ভুল করে
              হিন্দি হয়ে যাওয়ার পথ নেই।
           ⛔ পুরোনো বাংলা চাবিগুলো **মোছা হয়নি** — পুরোনো কোনো জায়গায় বাংলা
              থেকে গেলে সেটাও আগের মতোই হিন্দি হবে। */
        "Clock position" to "घड़ी की सुई के हिसाब से जगह",
        "All marks on the picture will be erased. Erase?" to "फोटो के सारे निशान मिट जाएँगे। मिटाएँ?",
        "Picture name" to "फोटो का नाम",
        "\n\n⚠️ If you approve, the record goes to the Trash Bin (it can be restored later)." to
            "\n\n⚠️ मंज़ूरी देने पर रिकॉर्ड Trash Bin में चला जाएगा (बाद में वापस लाया जा सकता है)।",
        /* ═══════════════════════════════════════════════════════════════════
        ...
        "ফেরানো গেল না — ইন্টারনেট দেখে আবার চেষ্টা করুন" to
            "वापस नहीं आया — इंटरनेट देखकर फिर कोशिश करें",
        "এই ফোনে ফিরল — ক্লাউডে পরে যাবে" to "इस फ़ोन में वापस आया — क्लाउड में बाद में जाएगा",
        "সরানো ছবি ফেরান" to "हटाई तस्वीर वापस लाएँ",
        "ফেরানো হচ্ছে…" to "वापस लाया जा रहा है…",
        "ফিরে এসেছে" to "वापस आ गई",
        "ফেরান" to "वापस",
        ...
        "অনেকদিন অ্যাপ ব্যবহার হয়নি, তাই নিরাপত্তার জন্য লগআউট করা হলো। মোবাইল ও পাসওয়ার্ড দিয়ে আবার লগইন করুন।" to
            "बहुत दिनों से ऐप इस्तेमाल नहीं हुआ, इसलिए सुरक्षा के लिए लॉगआउट कर दिया गया। मोबाइल और पासवर्ड से फिर लॉगिन करें।",
        "ডাক্তারদের জন্য হাজিরার ব্যবস্থা নেই — আপনি যেকোনো সময় আসতে ও যেতে পারেন।" to
            "डॉक्टरों के लिए हाज़िरी की व्यवस्था नहीं है — आप किसी भी समय आ और जा सकते हैं।",
        "ফেরানো হচ্ছে" to "वापस लाया जा रहा है",
        "অসময়" to "बेवक़्त",
        "নেট ঠিকমতো কাজ করছে না, তাই এই নম্বরটা আগে থেকে রেজিস্টার করা আছে কিনা দেখা গেল না।" to
            "नेट ठीक से काम नहीं कर रहा, इसलिए यह नंबर पहले से रजिस्टर है या नहीं, देखा नहीं जा सका।",
        /* 🟢 V591 — ওয়েবের ফেরানোর ঘরের নিজস্ব লেখা (app.js-এর যমজ)। */
        "কোন ছবিটা ফেরাবেন? নম্বর লিখুন" to "कौन सी तस्वीर वापस लाएँ? नंबर लिखें",
        "এই ব্রাউজারে ফিরল — ক্লাউডে পরে যাবে" to "इस ब्राउज़र में वापस आया — क्लाउड में बाद में जाएगा",
        "সরানো কোনো ছবি নেই" to "हटाई गई कोई तस्वीर नहीं है",
        "ছবিটা পাওয়া গেল না" to "तस्वीर नहीं मिली",
        "নম্বরটা মিলল না" to "नंबर मेल नहीं खाया",
        ...
        "অনুমোদন দিলে রেকর্ডটা Trash Bin-এ চলে যাবে (পরে ফেরানো যাবে)।" to
            "मंज़ूरी मिलने पर रिकॉर्ड Trash Bin में चला जाएगा (बाद में वापस लाया जा सकता है)।",
        "এটি হিসাব থেকে বাদ যাবে। চিরতরে মুছবে না — দরকারে ফেরানো যাবে।" to
            "यह हिसाब से बाहर हो जाएगा। हमेशा के लिए नहीं मिटेगा — ज़रूरत पड़ने पर वापस लाया जा सकता है।",
        "মাংস ফোলানো" to "माँस की सूजन",
        "নালীর দাগ" to "नली का निशान",
        "ফোলা:" to "सूजन:",
        "ক্ষার সূত্র" to "क्षार सूत्र",
        "ফোলান" to "सूजन",
        "মুছুন" to "मिटाएँ",
        "এমআরআই" to "एमआरआई",
        "◀ আগের" to "◀ पिछला",
        ...
        "কেন্দ্র" to "केंद्र",
        "চিকিৎসা" to "इलाज",
        "ফিস্টুলা" to "फिस्टुला",
        "রাজি নয়" to "राज़ी नहीं",
        "ছবির নাম" to "फोटो का नाम",
        "সব মুছুন" to "सब मिटाएँ",
        "রক্ত পড়ে" to "खून आता है",
        "ভেবে দেখব" to "सोचकर बताएँगे",
        "কবে থেকে?" to "कब से?",
        "একটা পিছনে" to "एक कदम पीछे",
        "পুরো পর্দা" to "पूरी स्क्रीन",
        "＋\nছবি যোগ" to "＋\nफोटो जोड़ें",
        "পরের ধাপ ▶" to "अगला चरण ▶",
        "নাম ছাড়াই" to "बिना नाम के",
        "কতদিন থেকে" to "कब से",
        "বাহ্যিক অর্শ" to "बाहरी बवासीर",
        "কোমলতা/ব্যথা" to "छूने पर दर्द",
        "কোলোনোস্কোপি" to "कोलोनोस्कोपी",
        "আগের চিকিৎসা" to "पहले का इलाज",
        "ফিস্টুলার মুখ" to "फिस्टुला का मुँह",
        "আল্ট্রাসাউন্ড" to "अल्ट्रासाउंड",
        "ল্যাব রিপোর্ট" to "लैब रिपोर्ट",
        "আর্থিক সমস্যা" to "पैसे की दिक्कत",
        "চিকিৎসায় রাজি" to "इलाज के लिए राज़ी",
        "নিজের তোলা ছবি" to "खुद की खींची फोटो",
        "অভ্যন্তরীণ অর্শ" to "अंदरूनी बवासीर",
        "হঠাৎ শুরু হয়েছে" to "अचानक शुरू हुआ",
        "তালিকা থেকে সরান" to "सूची से हटाएँ",
        "ধীরে ধীরে বেড়েছে" to "धीरे-धीरे बढ़ा",
        "পরিবারের সাথে আলোচনা" to "परिवार से बात करेंगे",
        "কলম — আঙুল দিয়ে লিখুন" to "कलम — उँगली से लिखें",
        "WhatsApp-এ পাঠানো যাবে।" to "WhatsApp पर भेजा जा सकेगा।",
        "ঘড়ির কাঁটা অনুযায়ী জায়গা" to "घड़ी की सुई के हिसाब से जगह",
        "ছবির সব দাগ মুছে যাবে। মুছব?" to "फोटो के सारे निशान मिट जाएँगे। मिटाएँ?",
        "ফোলান — মাংসের উপরে আঙুল টানুন" to "सूजन — माँस पर उँगली खींचें",
        "নালী — নালীর পথ ধরে আঙুল টানুন" to "नली — नली के रास्ते उँगली खींचें",
        "তীর — যেদিকে দেখাবেন সেদিকে টানুন" to "तीर — जिस ओर दिखाना है उधर खींचें",
        "গোল — যেটা ঘিরে দেখাবেন তার উপরে টানুন" to "गोल — जिसे घेरकर दिखाना है उस पर खींचें",
        "মুছুন — যে দাগটা তুলবেন তার উপরে ছুঁয়ে দিন" to "मिटाएँ — जो निशान हटाना है उसे छुएँ",
        "রিপোর্ট কোন ভাষায় বেরোবে — চাপ দিয়ে বদলান" to "रिपोर्ट किस भाषा में निकलेगी — दबाकर बदलें",
        "চিহ্ন — যেখানে চিহ্ন দেবেন সেখানে ছুঁয়ে দিন" to "निशान — जहाँ निशान लगाना है वहाँ छुएँ",
        "কেন্দ্র — পায়ুপথের ঠিক মাঝখানে একবার ছুঁয়ে দিন" to "केंद्र — गुदा के ठीक बीच में एक बार छुएँ",
        "এই রোগীর ডাক্তার চেক-আপ এখনো সম্পূর্ণ হয়নি।" to "इस मरीज़ का डॉक्टर चेक-अप अभी पूरा नहीं हुआ है।\n\n",
        "যে ফোলা বা নালীতে ক্ষারসূত্র দেখাবেন, সেটা ছুঁয়ে দিন" to "जिस सूजन या नली पर क्षार सूत्र दिखाना है, उसे छुएँ",
        "চেক-আপ শেষ করে Save করলে এখান থেকে রিপোর্ট দেখা, A4 প্রিন্ট ও" to "चेक-अप पूरा करके Save करने पर यहीं से रिपोर्ट देखना, A4 प्रिंट और",
        "ছবিটা মুছে যাবে না — পুরোনো চেক-আপে এর উপরে আঁকা থাকলে সেটা আগের মতোই দেখা যাবে।" to "फोटो मिटेगी नहीं — पुराने चेक-अप में इस पर बनाया हुआ पहले जैसा ही दिखेगा।",
        "\" ছবিটা তালিকা থেকে সরাব?" to "\" फोटो को सूची से हटाएँ?\n\n",
        "পেশা" to "पेशा",
        "পরামর্শ" to "सलाह",
        "অন্যান্য" to "अन्य",
        "প্রধান সমস্যা" to "मुख्य शिकायत",
        "রঙ" to "रंग",
        "সময়" to "समय",
        "অল্প" to "थोड़ा",
        "অনেক" to "बहुत",
        ...
        "তীব্রতা" to "तीव्रता",
        "যখন তখন" to "कभी भी",
        "মলের আগে" to "मल से पहले",
        "মলের পরে" to "मल के बाद",
        "দপদপ করা" to "धकधक करना",
        "পাতলা জল" to "पतला पानी",
        "তরলের ধরন" to "तरल का प्रकार",
        "টকটকে লাল" to "चटक लाल",
        "শুধু পুঁজ" to "सिर्फ़ पीब",
        "স্বাভাবিক" to "सामान्य",
        "দেখা যায়" to "दिखता है",
        "ব্যথার ধরন" to "दर्द का प्रकार",
        "দেখা যায় না" to "नहीं दिखता",
        "দুর্গন্ধযুক্ত" to "बदबूदार",
        "মলের সাথে মিশে" to "मल के साथ मिला हुआ",
        "রক্তযুক্ত পুঁজ" to "खून मिली पीब",
        "😣 ব্যথার ইতিহাস" to "😣 दर्द का इतिहास",
        "তীক্ষ্ণ কাটাকাটা" to "तेज़ चीरने जैसा",
        "🩸 রক্তপাতের ইতিহাস" to "🩸 खून आने का इतिहास",
        "সারাক্ষণ একটানা থাকে" to "लगातार बना रहता है",
        "💧 পুঁজ / জল পড়ার ইতিহাস" to "💧 पीब / पानी आने का इतिहास",
        "পায়ুপথের কাছে ছোট ছিদ্র" to "गुदा के पास छोटा छेद",
        "🫃 ফোলা / মাংসপিণ্ডের ইতিহাস" to "🫃 सूजन / माँस के लोथड़े का इतिहास",
        "ঠেলে ঢুকিয়ে দিতে হয় (Manual)" to "हाथ से अंदर करना पड़ता है (Manual)",
        "নিজে থেকে ভেতরে চলে যায় (Spontaneous)" to "अपने आप अंदर चला जाता है (Spontaneous)",
        "হঠাৎ তীব্র ব্যথাসহ শক্ত হয়ে ফুলে গেছে" to "अचानक तेज़ दर्द के साथ सख़्त होकर सूज गया है",
        "সারাক্ষণ বাইরেই বের হয়ে থাকে (Irreducible)" to "हमेशा बाहर ही निकला रहता है (Irreducible)",
        "মলত্যাগের সময় তীব্র হয় ও পরে কয়েক ঘন্টা থাকে" to "मल त्याग के समय तेज़ होता है और बाद में कुछ घंटे रहता है",
        "কোষ্ঠকাঠিন্য" to "कब्ज़",
        "মলদ্বারে ব্যথা" to "गुदा में दर्द",
        "পায়ুপথে রক্তপাত" to "गुदा से खून आना",
        "পুঁজ / রক্ত / জল পড়া" to "पीब / खून / पानी आना",
        "চুলকানি / জ্বালাপোড়া" to "खुजली / जलन",
        "ফোলা / মাংসপিণ্ড বের হওয়া" to "सूजन / माँस का लोथड़ा बाहर आना",
        "কম" to "कम",
        "পর্যাপ্ত" to "पर्याप्त",
        "ডায়াবেটিস" to "मधुमेह",
        "উচ্চ রক্তচাপ" to "उच्च रक्तचाप",
        "খাবারে ফাইবারের পরিমাণ" to "खाने में फाइबर की मात्रा",
        "দীর্ঘমেয়াদী কোনো রোগ আছে কি না?" to "कोई लंबी बीमारी है क्या?",
        "অতিরিক্ত কোঁথ (Straining) দিতে হয়?" to "ज़्यादा ज़ोर (Straining) लगाना पड़ता है?",
        "টয়লেটে দীর্ঘক্ষণ বসে থাকার অভ্যাস আছে?" to "शौचालय में देर तक बैठने की आदत है?",
        "সেমি" to "सेमी",
        "ছোট মুখ" to "छोटा मुँह",
        "ছোট ফোলা" to "छोटी सूजन",
        "একটা ফোলা" to "एक सूजन",
        "একটা ঢিবি" to "एक उभार",
        "রস গড়াচ্ছে" to "रिसाव हो रहा है",
        "খুব বড় মাংস" to "बहुत बड़ा माँस",
        "কয়েকটা ফোলা" to "कुछ सूजन",
        "চিকিৎসার পরে" to "इलाज के बाद",
        "অনেকগুলো আঁচিল" to "कई मस्से",
        "অপারেশনের সময়" to "ऑपरेशन के समय",
        "ফোলা · কাছ থেকে" to "सूजन · पास से",
        "আঁচিলের মত মাংস" to "मस्से जैसा माँस",
        "ফিস্টুলা · নালী" to "फिस्टुला · नली",
        "ফোলা · চওড়া ছবি" to "सूजन · चौड़ी तस्वीर",
        "কাটা ছবি · নরম রং" to "काट-चित्र · हल्के रंग",
        "লাল · বেরিয়ে আসা" to "लाल · बाहर निकला",
        "কাটা ছবি · গাঢ় রং" to "काट-चित्र · गहरे रंग",
        "অনেকটা বেরিয়ে আসা" to "काफ़ी बाहर निकला",
        "হাতে আঁকা · খালি ছক" to "हाथ से बना · खाली ख़ाका",
        "বই · ফিস্টুলার নকশা" to "किताब · फिस्टुला का नक्शा",
        "ঘা হয়ে যাওয়া মাংস" to "घाव वाला माँस",
        "বই · পাইলসের চার ধাপ" to "किताब · बवासीर के चार चरण",
        "বেরিয়ে আসা · বেগুনি" to "बाहर निकला · बैंगनी",
        "3D মডেল · ঘড়ির কাঁটা" to "3D मॉडल · घड़ी की सुई",
        "বই · ফিস্টুলার চার ধরন" to "किताब · फिस्टुला के चार प्रकार",
        "বই · ফোঁড়া কোথায় হয়" to "किताब · फोड़ा कहाँ होता है",
        "বই · পায়ুনালীর কাটা ছবি" to "किताब · गुदा नली का काट-चित्र",
        "চারপাশ জুড়ে বেরিয়ে আসা" to "चारों ओर से बाहर निकला",
        "চারপাশ জুড়ে · চওড়া ছবি" to "चारों ओर · चौड़ी तस्वीर",
        "ভিতরের পর্দা বেরিয়ে আসা" to "अंदर की झिल्ली बाहर आना",
        "রোগ:" to "रोग:",
        "সময়:" to "समय:",
        "বলেছেন:" to "कहा:",
        "আনুমানিক খরচ ₹" to "अनुमानित खर्च ₹",
        "1) ফিস্টুলার নালী" to "1) फिस्टुला की नली",
        "3) মাংস আরো ফুলে উঠল" to "3) माँस और सूज गया",
        "1) যেভাবে আঁকা হয়েছে" to "1) जैसा बनाया गया है",
        "5) কেটে পড়ল — জায়গা পরিষ্কার" to "5) कटकर गिर गया — जगह साफ़",
        "4) নালী কেটে গেল — জায়গা পরিষ্কার" to "4) नली कट गई — जगह साफ़",
        "3) দুই মাথায় গিঁট — বেঁধে রাখা হলো" to "3) दोनों सिरों पर गाँठ — बाँध दिया गया",
        "2) নালী বরাবর ক্ষারসূত্র পরানো হচ্ছে" to "2) नली के साथ क्षार सूत्र पिरोया जा रहा है",
        "2) ইনজেকশন দেওয়া হচ্ছে — ছুঁয়ে দেখান কোথায়" to "2) इंजेक्शन दिया जा रहा है — छूकर दिखाएँ कहाँ",
        "4) গোড়ায় ক্ষারসূত্র বাঁধা হলো — ছুঁয়ে সরানো যায়" to "4) जड़ में क्षार सूत्र बाँधा गया — छूकर हटाया जा सकता है",
        "উপর থেকে একটা ছবি বাছুন" to "ऊपर से एक फोटो चुनें",
        "গন্ধ" to "गंध",
        ...
        "এই ফোনের কোনো সিমে কি ক্লিনিকের চেম্বার/ব্রাঞ্চের নম্বরটা আছে? ব্যক্তিগত নম্বর হলে \"না\" বলুন।" to "Does any SIM in this phone carry the clinic's chamber/branch number? Say \"No\" if it is a personal number.",
        "এই ফোনের কোনো সিমে কি ক্লিনিকের চেম্বার/ব্রাঞ্চের নম্বরটা আছে? ব্যক্তিগত নম্বর হলে \"না\" বলুন — তাহলে Dialer-এ কোনো কল দেখানো হবে না।" to "Does any SIM in this phone carry the clinic's chamber/branch number? Say \"No\" if it is a personal number — then no calls are shown in the Dialer.",
        "এই ফোনে চেম্বারের নম্বর নেই বলে জানানো আছে, তাই কল দেখানো হচ্ছে না।\n\n👉 এটা ভুল হলে — এখানে চাপুন আবার জিজ্ঞাসা করতে" to "This phone is marked as not carrying the chamber number, so calls are not shown.\n\n👉 If that is wrong — tap here to be asked again",
        ...
        "ছবি যোগ হলো" to "फोटो जुड़ गई",
        "কেন্দ্র বসানো হলো — এবার চিহ্ন দিলেই ঘড়ির সময় নিজে বসবে" to
            "केंद्र सेट हो गया — अब निशान लगाते ही घड़ी का समय अपने आप आ जाएगा",
        "আগে ⊕ কেন্দ্র দিয়ে পায়ুপথের মাঝখানে একবার ছুঁয়ে দিন — তবেই ঘড়ির সময় নিজে বসবে" to
            "पहले ⊕ केंद्र से गुदा के ठीक बीच में एक बार छुएँ — तभी घड़ी का समय अपने आप आएगा",
        "মোছার মত কিছু নেই" to "मिटाने के लिए कुछ नहीं है",
        "তালিকা থেকে সরানো হলো" to "सूची से हटा दिया गया",
        "আগে উপরের সারি থেকে একটা ছবি বাছুন" to "पहले ऊपर की पंक्ति से एक फोटो चुनें",
        "এখানে ক্ষারসূত্র দেখানো যায় না — ফোলা বা নালী ছুঁয়ে দিন" to
            "यहाँ क्षार सूत्र नहीं दिखाया जा सकता — सूजन या नली को छुएँ",
        "ইনজেকশনের ধাপ থাকবে" to "इंजेक्शन का चरण रहेगा",
        "ইনজেকশনের ধাপ বাদ" to "इंजेक्शन का चरण हटाया गया",
        "আগে ছবিতে ফোলা বা নালী আঁকুন — তারপর ক্ষারসূত্র দেখানো যাবে" to
            "पहले फोटो में सूजन या नली बनाएँ — फिर क्षार सूत्र दिखाया जा सकेगा",
        "কাল আসার কথা" to "कल आने की बात",
        "\nমৌলিক বৃত্তান্ত" to "\nबुनियादी विवरण",
        "\nপ্রধান অভিযোগ" to "\nमुख्य शिकायत",
        "\nকতদিন থেকে" to "\nकब से",
        "\nপেশা" to "\nपेशा",
