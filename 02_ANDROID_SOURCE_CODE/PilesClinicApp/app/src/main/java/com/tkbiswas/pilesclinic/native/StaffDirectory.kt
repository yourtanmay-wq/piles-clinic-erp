...
object StaffDirectory {
    ...
    private val staff = listOf(
        ...
        // 🟢🔒 V1378 (১২.০৯.২০২৬, TK-নির্দেশ ও ডিটেলস সহ) — কিশানগঞ্জের নতুন
        //    স্টাফ **ISHRAT PARWEEN** (মহিলা), আগের নিয়ম মিলিয়ে কোড **KNE-KISHAN12**।
        StaffAccount("9679319516", "KNE-KISHAN12", "Kishanganj", "staff"),
