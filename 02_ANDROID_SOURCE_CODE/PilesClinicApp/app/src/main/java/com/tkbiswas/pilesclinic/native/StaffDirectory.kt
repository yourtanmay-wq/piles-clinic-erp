...
object StaffDirectory {
    ...
    private val staff = listOf(
        ...
        // 🟢🔒 V1137 (০৬.০৯.২০২৬, TK-নির্দেশ ও ডিটেলস সহ) — কিশানগঞ্জের আরেক
        //    নতুন স্টাফ **ARCHANA MANDAL BISWAS**, জয়েন ০৬.০৯.২০২৬।
        //    TK বলেছেন "KISHAN-11"; আগের সিদ্ধান্তে ঠিক হওয়া ব্রাঞ্চ-উপসর্গ মিলিয়ে
        //    **KNE-KISHAN11** (KNE-KISHAN10-এর হুবহু একই নিয়ম)।
        StaffAccount("7478288608", "KNE-KISHAN11", "Kishanganj", "staff"),
