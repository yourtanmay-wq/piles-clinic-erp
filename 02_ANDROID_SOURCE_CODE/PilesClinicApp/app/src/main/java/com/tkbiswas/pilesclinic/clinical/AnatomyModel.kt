...
object AnatomyModel {
     ...
     * ফোনে ছবিটা `anat_<key>`, ওয়েবে `img/anatomy/<key>.jpg`.
     */
    val PICTURES: List<Picture> = listOf(
        Picture("pic3_anal_canal", "বই · পায়ুনালীর কাটা ছবি"),
        Picture("pic1_parks_fistula", "বই · ফিস্টুলার ৪ ধরন"),
        Picture("pic2_fistula_types", "বই · ফিস্টুলার নকশা"),
        Picture("real1_pile_close", "ফোলা · কাছ থেকে"),
        Picture("real2_single_pile", "একটা ফোলা"),
        Picture("real9_single_lump", "একটা ঢিবি"),
        Picture("real20_small_prolapse", "ছোট ফোলা"),
        Picture("real8_pile_wide", "ফোলা · চওড়া ছবি"),
        Picture("real10_prolapse_red", "লাল · বেরিয়ে আসা"),
        Picture("real12_prolapse_ring2", "বেরিয়ে আসা · বেগুনি"),
        Picture("real7_prolapsed_ring", "চারপাশ জুড়ে বেরিয়ে আসা"),
        Picture("real21_rosette_wide", "চারপাশ জুড়ে · চওড়া ছবি"),
        Picture("real14_mucosa_prolapse", "ভিতরের পর্দা বেরিয়ে আসা"),
        Picture("real6_prolapsed_grade4", "অনেকটা বেরিয়ে আসা"),
        Picture("real11_giant_mass", "খুব বড় মাংস"),
        Picture("real19_infected_mass", "ঘা হয়ে যাওয়া মাংস"),
        Picture("real17_warty_mass", "আঁচিলের মত মাংস"),
        Picture("real22_warts_multiple", "অনেকগুলো আঁচিল"),
        Picture("real5_multiple_tags", "কয়েকটা ফোলা"),
        Picture("real3_fistula_opening", "ফিস্টুলার মুখ"),
        Picture("real4_fistula_track", "ফিস্টুলা · নালী"),
        Picture("real18_small_opening", "ছোট মুখ"),
        Picture("real13_discharge", "রস গড়াচ্ছে"),
        Picture("real15_after_procedure", "চিকিৎসার পরে"),
        Picture("real16_operation", "অপারেশনের সময়"),
    )
