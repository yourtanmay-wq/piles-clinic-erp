...
object SafeWideColumns {
    ...
    private val ALL: Map<String, String> = mapOf(
        ...
        "followups" to "id,address,age,branch,callCount,convertedPatientId,createdAt,createdBy,date,disease,history,lastCallDate,lastRemark,lastRemarkAt,mobile,name,nextFollow,patientId,photo,previousStage,refId,registrationDate,sex,stage,status,timeType,timeSource,updatedAt,visitDate",
