...
object SafeWideColumns {
    ...
    private val ALL: Map<String, String> = mapOf(
        "patients" to "id,address,age,altMobile,bill,branch,complaint,completeApprovedBy,completeRequestedBy,createdAt,createdBy,date,decision,diagnosis,discount,disease,doctorAdvice,doctorComplete,doctorFullNote,doctorReminderDate,doctorReminderNote,doctorReminderTime,editHistory,medicalHistory,mobile,name,occupation,patientId,photo,previousCost,previousResult,previousTreatment,queue,refBy,refDoctor,refDoctorMobile,refundRestoredBy,registeredBy,registrationDate,sex,sinceWhen,stage,timeType,treatmentDuration,updatedAt,visitDate,nextVisitPlan",
        "followups" to "id,address,age,branch,callCount,convertedPatientId,createdAt,createdBy,date,disease,history,lastCallDate,lastRemark,lastRemarkAt,mobile,name,nextFollow,patientId,photo,refId,registrationDate,sex,stage,status,timeType,updatedAt,visitDate",
