...
object SessionGuardBridge {
    ...
    fun onForeground(context: Context, activity: Activity) {
        ...
        // ── 🔒 অ্যাপ খোলার তালা — **সবার জন্য** (TK, ২১.০৮.২০২৬) ──────────
        //    আঙুল, নয়তো ফোনের পাসওয়ার্ড। Master-ও বাদ নন।
        //    ⛔ এটা কখনো হাজিরা নয় — শুধু অ্যাপ খোলা।
        //    ⚠️ মাস্টারের যাচাইয়ের **আগে** রাখা হয়েছে, নইলে মাস্টার নিচের
        //       `return`-এ বেরিয়ে যেতেন আর তাঁর ফোনে তালাই লাগত না।
        try { com.tkbiswas.pilesclinic.native.AppLock.guard(activity, user) } catch (_: Throwable) { }
