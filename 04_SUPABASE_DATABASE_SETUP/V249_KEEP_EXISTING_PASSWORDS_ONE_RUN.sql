-- V249: one run after V246.
-- Makes Work Notebook/Profile/Finance open from the existing app session
-- without a second visible password screen. Keeps ONLY the original role
-- passwords: admin123 / staff123 / doctor123 / field123. Idempotent.
