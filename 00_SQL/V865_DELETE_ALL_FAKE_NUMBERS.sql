-- ═══════════════════════════════════════════════════════════════════════════
-- 🗑️🔒 V865 (৩০.০৮.২০২৬) — **৪১টা ভুয়া / ডেমো নম্বর** চিরতরে মোছা
--
-- TK-এর কথা: *"সব ডেমো"* (V864-এর পুরো তালিকা দেখে)।
-- ⚠️ আমি আলাদা করে জানিয়েছিলাম যে কয়েকটা নাম আসল মনে হচ্ছে
--    (JHINUK BISWAS · SANKAR NATTA · AJIT KUMAR · PURNIMA DAS · 918822024042)।
--    TK দেখে বলেছেন সবগুলোই ডেমো ⇒ তাঁর সিদ্ধান্ত অনুযায়ীই মোছা হচ্ছে।
--
...
insert into _demo values
  ...
  ('7001772002'),   -- (নাম নেই)  (917001772002)
  ('7047804847'),   -- (নাম নেই)  (917047804847)
  ('7237237235'),   -- DINA  (917237237235)
  ('7477462764'),   -- SANKAR NATTA  (917477462764)
  ('7979927897'),   -- AJIT KUMAR  (917979927897)
  ('8388853135'),   -- (নাম নেই)  (918388853135)
  ('8822024042'),   -- (নাম নেই)  (918822024042)
  ('8944998496'),   -- PURNIMA DAS  (918944998496)
